...
//        {
//            ImageLibrary.minimal_solution_setup( ( universe ) => { }, CtrlKeyHandler.IsPressed );
//        }

//        [Test]
//        public void a_simple_project_can_be_opened()
//        {
//            ImageLibrary.minimal_solution_open( ( a, b ) => { }, CtrlKeyHandler.IsPressed );
//        }
...
//                }
//            }, CtrlKeyHandler.IsPressed );
//        }

//        [Test]
//        public void a_simple_project_can_apply_settings()
//        {
//            ImageLibrary.minimal_solution_apply_settings( ( a, b ) => { }, CtrlKeyHandler.IsPressed );
//        }
...
//                        Path.GetFileName( files.Single() ).Should().Be( "CKTest.Code.Cake.0.1.1--0010-develop.nupkg" );
//                    },
//                    CtrlKeyHandler.IsPressed
//                );
//        }
...
//        {
//            ImageLibrary.minimal_solution_second_ci_build( ( universe, world ) => { }, CtrlKeyHandler.IsPressed ); //We are now sure this image, and it's base exist.
...
//        {
//            bool isExplicit = CtrlKeyHandler.IsPressed;
