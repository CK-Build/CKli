...
namespace CK.Env.Plugin
{
    ...
    {
        /// <summary>
        /// Gets a <see cref="IFileInfo"/> in the <see cref="CurrentBranchName"/> and its path (relative to the <see cref="GitRepository.FileSystem"/>).
        /// The file info is null if the file doesn't exist on the file system.
        /// </summary>
