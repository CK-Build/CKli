...
namespace CK.Env.DependencyModel
{
    ...
    public class DependentSolution
    {
        ...
        public readonly struct Row
        {
            ...
            {
                var capture = Target;
                if( capture == null ) return Array.Empty<ArtifactInstance>();
        ...
        internal DependentSolution( ISolution s,
                                    IReadOnlyList<Row> dependencyTable,
                                    Func<ISolution, DependentSolution> others )
        {
            Solution = s;
            DirectRequirements = dependencyTable.Where( r => r.Origin.Solution == s && r.Target != null )
        ...
        /// </summary>
        public IReadOnlyList<DependentSolution> DirectRequirements { get; }

        /// <summary>
        /// Gets the minimal set of required solutions: this is the sub set of the <see cref="DirectRequirements"/>
        ...
        /// </summary>
        [AllowNull]
        public IReadOnlyList<DependentSolution> DirectImpacts { get; private set; }

        /// <summary>
        /// Gets the minimal set of impacted solutions: this is the sub set of the <see cref="DirectImpacts"/>
        ...
        /// Only packages that are produced by <see cref="DirectRequirements"/> are considered.
        /// </summary>
        [AllowNull]
        ...
        {
            Solutions = solutions;
            DirectImpacts = solutions.DependencyTable.Where( r => r.Target != null && r.Target.Solution == Solution )
