...
namespace CK.Env
{
    ...
    public interface IEnvLocalFeed
    {
        ...
        HashSet<ArtifactInstance> GetMissing( IActivityMonitor monitor, IEnumerable<ArtifactInstance> artifacts );
        ...
        void Remove( IActivityMonitor monitor, IEnumerable<ArtifactInstance> artifacts );
        ...
        bool PushLocalArtifacts( IActivityMonitor monitor, IArtifactRepository target, IEnumerable<ArtifactInstance> artifacts, bool arePublicArtifacts );
        ...
        /// <param name="monitor">The monitor to use.</param>
        /// <returns>True on success, false on error.</returns>
        bool RemoveAll( IActivityMonitor monitor );
    }
}
