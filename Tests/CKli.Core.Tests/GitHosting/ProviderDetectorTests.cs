...
//    {
//        using var provider = GitHostingProviderDetector.CreateProvider( "github", "github.com", _noCredentials );

//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GitHubProvider>();
//        provider!.HostName.ShouldBe( "github.com" );
...
//    {
//        using var provider = GitHostingProviderDetector.CreateProvider( "github", "github.mycompany.com", _noCredentials );

//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GitHubProvider>();
//        provider!.HostName.ShouldBe( "github.mycompany.com" );
...
//    {
//        using var provider = GitHostingProviderDetector.CreateProvider( "gitlab", "gitlab.com", _noCredentials );

//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GitLabProvider>();
//        provider!.HostName.ShouldBe( "gitlab.com" );
...
//    {
//        using var provider = GitHostingProviderDetector.CreateProvider( "gitlab", "gitlab.internal.org", _noCredentials );

//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GitLabProvider>();
//        provider!.HostName.ShouldBe( "gitlab.internal.org" );
//        provider.CloudProvider.ShouldBe( KnownCloudGitProvider.Unknown );
...
//    {
//        using var provider = GitHostingProviderDetector.CreateProvider( "gitea", "gitea.company.com", _noCredentials );

//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GiteaProvider>();
//        provider!.HostName.ShouldBe( "gitea.company.com" );
...
//    {
//        var provider = GitHostingProviderDetector.CreateProvider( "unknown", "some.host.com", _noCredentials );
...
//    {
//        using var provider1 = GitHostingProviderDetector.CreateProvider( "GITHUB", "github.com", _noCredentials );
//        using var provider2 = GitHostingProviderDetector.CreateProvider( "GitHub", "github.com", _noCredentials );
//        using var provider3 = GitHostingProviderDetector.CreateProvider( "gitHub", "github.com", _noCredentials );
...
//        using var provider = await GitHostingProviderDetector.ResolveProviderAsync(
//            monitor,
//            _noCredentials,
...
//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GiteaProvider>();
//        provider!.HostName.ShouldBe( "gitea.mycompany.com" );
//    }
...
//        provider.ShouldNotBeNull();
//        provider.ShouldBeOfType<GitHubProvider>();
//        provider!.HostName.ShouldBe( "github.enterprise.com" );
