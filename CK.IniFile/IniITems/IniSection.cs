...
namespace CK.IniFile.IniITems
{
    ...
    public sealed class IniSection : IniItem
    {
        ...
        /// </summary>
        public IniKeyCollection Keys { get { return keys; } }

        /// <summary>
        /// Gets the <see cref="IniSectionCollection"/> to which this <see cref="IniSection"/> belongs to.
        /// </summary>
        public IniSectionCollection ParentCollection { get { return (IniSectionCollection)ParentCollectionCore; } }
        ...
        {
            keys = new IniKeyCollection( parentFile, this, parentFile.options.KeyDuplicate, parentFile.options.KeyNameCaseSensitive );
        }
        ...
        {
            keys = new IniKeyCollection( destinationFile, this, destinationFile.options.KeyDuplicate, destinationFile.options.KeyNameCaseSensitive );

            foreach( IniKey key in sourceSection.keys )
                keys.Add( key.Copy( destinationFile ) );
        }
        ...
        public IniSection Copy() { return Copy( ParentFile ); }
