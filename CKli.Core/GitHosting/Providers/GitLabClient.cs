...
internal sealed class GitLabClient : IDisposable
{
    ...
    /// </summary>
    public async Task<GitHostingOperationResult<RepositoryInfo>> GetProjectAsync(
    ...
    /// </summary>
    public async Task<GitHostingOperationResult<RepositoryInfo>> CreateProjectAsync(
        IActivityMonitor monitor,
    ...
    static RepositoryInfo MapToRepositoryInfo( GitLabProject project )
    {
