...
//    /// <inheritdoc />
//    public string HostName => _instanceId;

//    /// <inheritdoc />
//    public Uri BaseApiUrl => _baseApiUrl;

//    /// <summary>
//    /// Gitea can archive repositories.
//    /// </summary>
...
//        if( client == null )
//        {
//            return GitHostingOperationResult<HostedRepositoryInfo>.Fail( $"No Gitea PAT available. Set {GetWritePatKey()} in secrets." );
//        }
