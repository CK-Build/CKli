...
//        _hostName = instanceId ?? "gitlab.com";
//        _baseApiUrl = _hostName == "gitlab.com"
//            ? new Uri( "https://gitlab.com/api/v4/" )
//            : new Uri( $"https://{_hostName}/api/v4/" );
...
//        string.Equals( _hostName, "gitlab.com", StringComparison.OrdinalIgnoreCase )
...
//    /// <summary>
//    /// Repositories can be archived on any GitLab.
//    /// </summary>
...
//        if( client == null )
//        {
//            return GitHostingOperationResult<HostedRepositoryInfo>.Fail( $"No GitLab PAT available. Set {GetWritePatKey()} in secrets." );
//        }
...
//    {
//        if( string.Equals( _hostName, "gitlab.com", StringComparison.OrdinalIgnoreCase ) )
//        {
...
//        var sanitized = BadPATChars().Replace( _hostName, "_" ).ToUpperInvariant();
