                                                      ...
                                                      CommandLineArguments cmdLine )
    {
        ...
        if( cmdLine.HasInteractiveArgument )
        {
            for( int i = 0; i < 14; i++ )
            {
                ...
                {
                    monitor.Warn( $"open n°{i} - wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww" );
                }
            }
            for( int i = 0; i < 12; i++ )
            {
                ...
                if( Random.Shared.Next( 3 ) == 1 )
                {
                    monitor.Warn( $"close n°{i} - wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww" );
                }
            }
