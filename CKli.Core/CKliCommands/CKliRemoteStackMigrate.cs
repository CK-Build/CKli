...
// This should actually detect if the remote url "has moved" from its current value to the new one and
// if it's not the case, then this should "move":
// - create the new one.
// - change the remote url.
// - push the content.
// - on success, archive the previous one.
//
