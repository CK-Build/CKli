...
namespace CodeCake
{
    public static class StandardGlobalInfoCKSetupExtension
    {
        /// <summary>
        ...
        public static StandardGlobalInfo AddCKSetup( this StandardGlobalInfo globalInfo, NPMSolution solution )
        {
