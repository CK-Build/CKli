...
sealed partial class ReflectionPluginCollector
{
    sealed partial class Factory : IPluginFactory
    {
        ...
        {
            var version = World.CKliVersion.Version?.ToString() ?? "0.0.0";
            var b = new StringBuilder( $$"""
            // <auto-generated>
            // This file was generated by CKli v{{version}}.
            ...
            """ );
            int offset = 8;
            b.Append( ' ', offset ).Append( $"var objects = new object[" ).Append( _activationList.Count ).Append( "];" ).AppendLine();
            for( int i = 0; i < _activationList.Count; i++ )
            {
                PluginType? dep = _activationList[i];
                b.Append( ' ', offset ).Append( $"objects[{i}] = new " ).Append( dep.TypeName ).Append( "( " );
                for( int j = 0; j < dep.Deps.Length; ++j )
                {
                    ...
                    if( iInstance == -1 )
                    {
                        ...
                        else if( j == dep.PrimaryPluginParameterIndex )
                        {
                            ...
                            b.Append( $"new PrimaryPluginContext( _plugins[" ).Append( idxPlugin ).Append( "], configs, world )" );
                        }
                        else
                        {
                            b.Append( "null" );
        ...
        static void GenerateCommand( StringBuilder b, PluginCommand c, string version )
        {
            b.Append( "[GeneratedCode(\"CKli\", \"" ).Append( version ).Append( "\")]" ).AppendLine();
