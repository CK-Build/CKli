...
{
    static ReadOnlySpan<byte> _configSignature => [224,20,146,205,179,28,47,7,117,120,88,87,88,1,191,248,133,71,18,6];
    ...
    public static IPluginFactory UncheckedGet()
    {
        var infos = new PluginInfo[]{
            new PluginInfo( "CKli.BranchModel.Plugin", "BranchModel", (PluginStatus)0, "0.0.8--0277-dev/dffb21a25dc5562704fa84dc84ce8a44167e1c9a/2026-05-11 13:01:34Z", new IPluginTypeInfo[1] ),
            ...
            new PluginInfo( "CKli.ShallowSolution.Plugin", "ShallowSolution", (PluginStatus)0, "0.0.8--0277-dev/dffb21a25dc5562704fa84dc84ce8a44167e1c9a/2026-05-11 13:01:34Z", new IPluginTypeInfo[1] ),
        ...
        plugin = infos[5];
        types = (IPluginTypeInfo[])plugin.PluginTypes;
        types[0] = new PluginTypeInfo( plugin, "CKli.Net8Migration.Plugin.Net8MigrationPlugin", true, 0, 8 );
        plugin = infos[6];
        types = (IPluginTypeInfo[])plugin.PluginTypes;
        types[0] = new PluginTypeInfo( plugin, "CKli.ShallowSolution.Plugin.ShallowSolutionPlugin", true, 0, 0 );
        plugin = infos[7];
        types = (IPluginTypeInfo[])plugin.PluginTypes;
        types[0] = new PluginTypeInfo( plugin, "CKli.CommonFiles.Plugin.CommonFilesPlugin", true, 0, 9 );
        plugin = infos[8];
        types = (IPluginTypeInfo[])plugin.PluginTypes;
        ...
        var pluginCommands = new PluginCommand[]{
            ...
            new Cmd_version＿deprecate( infos[1].PluginTypes[0] ),
            new Cmd_maintenance＿release_database＿rebuild( infos[1].PluginTypes[0] ),
            new Cmd_fix＿start( infos[9].PluginTypes[0] ),
            new Cmd_fix＿info( infos[9].PluginTypes[0] ),
            new Cmd_fix＿cancel( infos[9].PluginTypes[0] ),
...
sealed class Generated : IPluginFactory
{
    ...
    public PluginCollection Create( IActivityMonitor monitor, World world )
    {
        ...
        objects[0] = new CKli.ShallowSolution.Plugin.ShallowSolutionPlugin( new PrimaryPluginContext( _plugins[6], configs, world ) );
        objects[1] = new CKli.BranchModel.Plugin.BranchModelPlugin( new PrimaryPluginContext( _plugins[0], configs, world ), (CKli.ShallowSolution.Plugin.ShallowSolutionPlugin)objects[0] );
        objects[2] = new CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin( new PrimaryPluginContext( _plugins[4], configs, world ), (CKli.BranchModel.Plugin.BranchModelPlugin)objects[1] );
        objects[3] = new CKli.ReleaseDatabase.Plugin.ReleaseDatabasePlugin( new PrimaryPluginContext( _plugins[3], configs, world ), (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[2] );
        objects[4] = new CKli.VersionTag.Plugin.VersionTagPlugin( new PrimaryPluginContext( _plugins[1], configs, world ), (CKli.ReleaseDatabase.Plugin.ReleaseDatabasePlugin)objects[3], (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[2] );
        objects[5] = new CKli.HotZone.Plugin.HotZonePlugin( new PrimaryPluginContext( _plugins[9], configs, world ), (CKli.BranchModel.Plugin.BranchModelPlugin)objects[1], (CKli.VersionTag.Plugin.VersionTagPlugin)objects[4], (CKli.ShallowSolution.Plugin.ShallowSolutionPlugin)objects[0], (CKli.ReleaseDatabase.Plugin.ReleaseDatabasePlugin)objects[3], (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[2] );
        ...
        objects[8] = new CKli.Net8Migration.Plugin.Net8MigrationPlugin( new PrimaryPluginContext( _plugins[5], configs, world ), (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[2], (CKli.VersionTag.Plugin.VersionTagPlugin)objects[4], (CKli.BranchModel.Plugin.BranchModelPlugin)objects[1], (CKli.HotZone.Plugin.HotZonePlugin)objects[5], (CKli.Build.Plugin.BuildPlugin)objects[7] );
        objects[9] = new CKli.CommonFiles.Plugin.CommonFilesPlugin( new PrimaryPluginContext( _plugins[7], configs, world ), (CKli.BranchModel.Plugin.BranchModelPlugin)objects[1], (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[2] );
        objects[10] = new CKli.Publish.Plugin.PublishPlugin( new PrimaryPluginContext( _plugins[8], configs, world ), (CKli.Build.Plugin.BuildPlugin)objects[7], (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[2], (CKli.ReleaseDatabase.Plugin.ReleaseDatabasePlugin)objects[3], (CKli.VersionTag.Plugin.VersionTagPlugin)objects[4] );
...
sealed class Cmd_ci＿build : PluginCommand
{
    internal Cmd_ci＿build( IPluginTypeInfo typeInfo )
        : base( typeInfo,
                ...
                "CIBuild", MethodAsyncReturn.Task ) {}
    protected override ValueTask<bool> HandleCommandAsync( IActivityMonitor monitor, CKliEnv context, CommandLineArguments cmdLine )
    {
        var o0 = cmdLine.EatSingleOption( Options[0].Names );
        var o1 = cmdLine.EatSingleOption( Options[1].Names );
        ...
        if( !cmdLine.Close( monitor ) ) return ValueTask.FromResult( false );
        return new ValueTask<bool>( ((CKli.Build.Plugin.BuildPlugin)Instance).CIBuild(
...
sealed class Cmd_ci＿publish : PluginCommand
{
    internal Cmd_ci＿publish( IPluginTypeInfo typeInfo )
        : base( typeInfo,
                ...
                "CIPublish", MethodAsyncReturn.Task ) {}
    protected override ValueTask<bool> HandleCommandAsync( IActivityMonitor monitor, CKliEnv context, CommandLineArguments cmdLine )
    {
        var o0 = cmdLine.EatSingleOption( Options[0].Names );
        var o1 = cmdLine.EatSingleOption( Options[1].Names );
        ...
        var f3 = cmdLine.EatFlag( Flags[3].Names );
        if( !cmdLine.Close( monitor ) ) return ValueTask.FromResult( false );
        return new ValueTask<bool>( ((CKli.Build.Plugin.BuildPlugin)Instance).CIPublish(
                                           monitor, context, o0, o1, f0, f1, f2, f3 ) );
    }
}
[GeneratedCode("CKli", "0.0.8--0277-dev")]
sealed class Cmd_ci＿жbuild : PluginCommand
{
    internal Cmd_ci＿жbuild( IPluginTypeInfo typeInfo )
        : base( typeInfo,
                ...
                "CIStarBuild", MethodAsyncReturn.Task ) {}
    protected override ValueTask<bool> HandleCommandAsync( IActivityMonitor monitor, CKliEnv context, CommandLineArguments cmdLine )
    {
        var o0 = cmdLine.EatSingleOption( Options[0].Names );
        var o1 = cmdLine.EatSingleOption( Options[1].Names );
        ...
        var f3 = cmdLine.EatFlag( Flags[3].Names );
        if( !cmdLine.Close( monitor ) ) return ValueTask.FromResult( false );
        return new ValueTask<bool>( ((CKli.Build.Plugin.BuildPlugin)Instance).CIStarBuild(
                                           monitor, context, o0, o1, f0, f1, f2, f3 ) );
    }
}
[GeneratedCode("CKli", "0.0.8--0277-dev")]
sealed class Cmd_ci＿жpublish : PluginCommand
{
    internal Cmd_ci＿жpublish( IPluginTypeInfo typeInfo )
        : base( typeInfo,
                ...
                "CIStarPublish", MethodAsyncReturn.Task ) {}
    protected override ValueTask<bool> HandleCommandAsync( IActivityMonitor monitor, CKliEnv context, CommandLineArguments cmdLine )
    {
        var o0 = cmdLine.EatSingleOption( Options[0].Names );
        var o1 = cmdLine.EatSingleOption( Options[1].Names );
        ...
        var f3 = cmdLine.EatFlag( Flags[3].Names );
        if( !cmdLine.Close( monitor ) ) return ValueTask.FromResult( false );
        return new ValueTask<bool>( ((CKli.Build.Plugin.BuildPlugin)Instance).CIStarPublish(
                                           monitor, context, o0, o1, f0, f1, f2, f3 ) );
    }
}
[GeneratedCode("CKli", "0.0.8--0277-dev")]
