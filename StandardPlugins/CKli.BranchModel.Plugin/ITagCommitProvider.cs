...
public interface ITagCommitProvider
{
    ...
    /// <param name="ciLinkType">True when the subordinated branch is configured with <see cref="BranchLinkType.CI"/>.</param>
    /// <returns>The versioned tagged commit on success, null otherwise.</returns>
    ITagCommit? GetCommit( IActivityMonitor monitor, HotBranch branch, bool ciLinkType );
}
