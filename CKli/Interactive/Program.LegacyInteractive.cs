    ...
    partial class Program
    {
        static void LegacyInteractive( ActivityMonitor monitor )
        {
            ...
            try
            {
                ...
                if( target != null )
                {
                    var home = SingleWorldHome.Create( monitor, target, appContext );
                    if( home != null )
                    {
                ...
                multiHome = MultipleWorldHome.Create( monitor, appContext, keyVault, mappings );
        ...
        static void RunCommand( IActivityMonitor m, CommandRegistry commandRegister, string rep )
        {
